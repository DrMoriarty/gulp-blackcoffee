...
var coffee = require('blackcoffee');
...
module.exports = function (opt) {
  ...
  function transform(file, enc, cb) {
    ...
    if (file.isStream()) return cb(new PluginError('gulp-blackcoffee', 'Streaming not supported'));
    ...
    try {
      ...
      return cb(new PluginError('gulp-blackcoffee', err));
    }
